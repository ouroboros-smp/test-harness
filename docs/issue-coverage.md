...
| #18–#21 | Coffer Fabric placement, double chest, trust/access policy, API, commands, and restart persistence | `coffer/runtime-acceptance` |
| #22 | Coffer packaging/interoperability plus the generated production-stack loader/restart gate | `coffer/runtime-acceptance`, `portfolio/full-manifest-interop` (generated by `interop`) |
